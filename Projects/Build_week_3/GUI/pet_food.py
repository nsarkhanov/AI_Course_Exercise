...
class Pet_food(metaclass = IterRegistry):
    ...
    def draw_food(self, image):
        ...
        if self.item_type == 'bone':
            ...
            img = cv2.circle(img, (start_x + w, start_y + h), 15, Pet_food.WHITE, -1)
            ...
            img = cv2.putText(image, 'S', (x - int(self.dimension), y + int(self.dimension)), Pet_food.FONT, 2.5, Pet_food.GREEN, 8)
            img = cv2.circle(img, (x + 13, y - 18), 12, Pet_food.GREEN, -1)
